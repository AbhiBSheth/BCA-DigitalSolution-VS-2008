<%@ Page Language="C#" MasterPageFile="~/user/user.master" AutoEventWireup="true" CodeFile="Aadhaars.aspx.cs" Inherits="user_Aadhaars" Title="Aadhar Card Search" %>
...
<center>
    <table>
        <tr>
            <td>
                <div>
                   <font face="DigifaceWide" color="#003399"><h2>Aadhar Card Search</h2></font>
                </div>
            </td>
        </tr>
        <tr>
