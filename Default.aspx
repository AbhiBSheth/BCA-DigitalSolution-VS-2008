<%@ Page Language="C#" MasterPageFile="~/visitor.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" Title="Home" %>
...
<center>
	<table style="width: 100%">
        <tr style="width: 100%">
            <td style="width: 100%">
                <!-- Start Slider.com -->
                <iframe src="slider.html" scrolling="no" style="width: 100%; height: 360px; max-width: 100%;
                    overflow: hidden; border: none; padding: 0; margin: 0 auto; display: block;"
...
<table>
    ...
    <tr align="right">
			<td>
				<a href="images/map.png"><img src="images/map.png" width="30%"></a><br>
			</td>
		</tr>
</center>
</body>
