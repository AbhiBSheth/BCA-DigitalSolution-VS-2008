<%@ Page Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="admin_Default" Title="HOME" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="server">
   <center>
    <h1 style="text-align: center; color: Blue;">Welcome Admin :: <asp:LoginName ID="LoginName1" runat="server" /></h1>
<table width="50%">	
	<tr>
		<td align="justify">
...
<table>
	<tr width="100%">
		<td width="33.3%"><img src="../images/download.png" width="400px" height="200px"></td>
	...
	<tr width="100%">
		<td width="33.3%"><img src="../images/addhar.png" width="400px" height="200px"></td>
	...
	<tr width="100%">
		<td width="33.3%"><img src="../images/digital signature.png" width="400px" height="200px"></td> 		
